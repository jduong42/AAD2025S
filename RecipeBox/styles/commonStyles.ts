...
import { dimensions, lightTheme, shadows } from "./theme";
...
export const buttonStyles = StyleSheet.create({
  ...
  // semi oval submit button
  submitButton: {
    backgroundColor: lightTheme.colors.primary,
    borderRadius: 30, // Large border radius for pill shape
    paddingVertical: lightTheme.spacing.xs,
    paddingHorizontal: lightTheme.spacing.lg,
    alignItems: "center",
    justifyContent: "center",
    marginTop: lightTheme.spacing.lg,
    marginHorizontal: lightTheme.spacing.xxl, // Center with margins
    minHeight: 50,
